...
- (void)loadAgoraKitAndAudioController {
    ...
    // Set capture format
    [self.agoraKit setRecordingAudioFrameParametersWithSampleRate:(NSInteger)self.sampleRate channel:self.channels mode:AgoraAudioRawFrameOperationModeWriteOnly samplesPerCall:(NSInteger)self.sampleRate * self.channels * 0.01]; // samplesPerCall : sampleRate * channels * duration
    [self.agoraKit setPlaybackAudioFrameParametersWithSampleRate:(NSInteger)self.sampleRate channel:self.channels mode:AgoraAudioRawFrameOperationModeReadOnly samplesPerCall:(NSInteger)self.sampleRate * self.channels * 0.01];
