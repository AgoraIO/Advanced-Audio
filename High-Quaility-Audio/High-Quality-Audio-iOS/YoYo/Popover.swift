...
open class Popover: UIView {
    ...
    override open func draw(_ rect: CGRect) {
        ...
        let blueArrow = UIBezierPath()
        blueArrow.lineWidth = 1
        ...
        case .up:
            ...
            arrow.addLine(to: CGPoint(x: self.popCornerRadius, y: self.bounds.height - self.arrowSize.height))
            arrow.addArc(
                withCenter: CGPoint(
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width - self.popCornerRadius, y: 0))
            arrow.addArc(
                withCenter: CGPoint(
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.arrowSize.height - self.popCornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.popCornerRadius,
                    y: self.bounds.height - self.arrowSize.height - self.popCornerRadius
        ...
        case .down, .auto:
            ...
            blueArrow.move(to: CGPoint(x: arrowPoint.x, y: 1))
            blueArrow.addLine(
                to: CGPoint(
            ...
            blueArrow.addLine(to: CGPoint(x: arrowPoint.x -  self.arrowSize.width * 0.5 + 1, y: self.arrowSize.height + 1))
            blueArrow.addLine(to: CGPoint(x: arrowPoint.x, y: 1))
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width - self.popCornerRadius, y: self.arrowSize.height))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.popCornerRadius,
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.popCornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.popCornerRadius,
        ...
        let blueColor = UIColor.init(hexString: "#09BDF4")
        blueColor?.setFill()
        blueArrow.fill()
    }
}
